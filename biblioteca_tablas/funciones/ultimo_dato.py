"""Función de celda: valor numérico de la última lectura válida de un sensor."""
...
CELL_FUNCTION_METADATA: dict[str, Any] = {
    "nombre": "ultimo_dato",
    "devuelve": "numero",
    "descripcion": "Devuelve el valor numérico de la última lectura válida del sensor, redondeado.",
    "parametros": [
...
def evaluate(
    ...
    """Devuelve el valor de la última lectura válida del sensor antes de ``fecha_limite``.
    ...
    Returns:
        Último valor redondeado, o cadena vacía si no hay lecturas.
    """
    ...
    if lecturas:
        return round(lecturas[-1][1], decimales)
    return ""
