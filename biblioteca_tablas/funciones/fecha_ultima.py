"""Función de celda: fecha de la última lectura válida de un sensor."""
...
CELL_FUNCTION_METADATA: dict[str, Any] = {
    "nombre": "fecha_ultima",
    "devuelve": "texto",
    "descripcion": "Devuelve la fecha de la última lectura válida del sensor.",
    "parametros": [
...
def evaluate(
    ...
    """Devuelve la fecha de la última lectura válida del sensor antes de ``fecha_limite``.
    ...
    Returns:
        Fecha formateada de la última lectura, o cadena vacía si no hay lecturas.
    """
