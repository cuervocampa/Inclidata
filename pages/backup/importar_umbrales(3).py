...
def register_callbacks(app):
            ...
            for deformada in deformadas:
                selectors.append(
                    dmc.Paper(
                        ...
                        children=[
                            dmc.Group(
                                noWrap=True,  # aquí evitamos el wrap
                                gap="1",
                                children=[
    ...
    def process_flancos(n_clicks, name_values, flanco_values, nivel_values, datos_json, deformadas, excel_contents):
        ...
        try:
            ...
            # Construir dict de deformadas con flanco + nivel
            deformadas_dict = {
