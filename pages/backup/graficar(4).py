            ...
            dmc.Drawer(
                ...
                children=[
                    ...
                    dmc.RadioGroup(
                        ...
                        children=[
                            dmc.Radio("Monocromo", value="monocromo"),
                            dmc.Radio("Multicromo", value="multicromo"),
                        ],
...
def get_color_for_index(index, color_scheme="multicromo", total_colors=10):
    if color_scheme == "monocromo":
        ...
        return color_palette_multicromo[index % len(color_palette_multicromo)]
        ...
        for fecha in fechas_seleccionadas:
            if fecha in data and "calc" in data[fecha]:
                ...
                if fecha == fecha_slider:
                    ...
                    total_colors = len(fechas_seleccionadas)
                    color = get_color_for_index(index, color_scheme, total_colors)
                    grosor = 2
