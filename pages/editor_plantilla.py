...
from pages.editor_plantilla_layout import layout
    ...
    def toggle_create_group_modal(n_open, n_cancel, n_save, store_data, is_open):
        ...
        if trigger_id == "ep-create-group-btn":
            ...
            try:
                ...
                # Debug
                pass  # print(f"DEBUG: Creando grupo. Pág actual: {pagina_actual}. Páginas disponibles: {list(paginas.keys())}")
                ...
                if not elementos:
                     ...
                     if int(pagina_actual) in paginas:
                         pass  # print(f"DEBUG: Encontrada página como int {int(pagina_actual)}")
